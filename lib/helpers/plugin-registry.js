...
module.exports = {
  ...
  searchPlugin: function (query){
    return new Promise(function (resolve, reject){
      request({
        uri: registryUrl+'/plugins?query='+query,
        method: 'GET',
        json: true
  ...
  publishPlugin: function (pluginName, payload){
    return new Promise(function (resolve, reject){
      request({
        uri: registryUrl+'/plugins/'+pluginName,
        method: 'PUT',
        json: payload
      }, function(err, res, json){
        if (!err && res.statusCode === 200){
